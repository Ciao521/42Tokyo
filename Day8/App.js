...
function App() {
    ...
    const [access, setaccess] = useState("0x774416f18d777c4f25aa775d8ecdbe3f99880278");//access
    //privatekey
    ...
    const [privateKey4, setPrivateKey4] = useState("c7223bf42b2ae721f8822cc1246280e645d83d00eab787628b175a1cb8ec0282");//access
     ...
     <div>
        ...
        <div className="step0-section">
            ...
            <p><b>ステップ7.アクセスコントロール</b></p>
                <input type="text" value={renter} onChange={e => setRenter(e.target.value)} placeholder="Your Address" />
